package com.black_dog20.torchaction.common.network;
...
public class PacketHandler {
    ...
    public static final SimpleChannel NETWORK = NetworkRegistry.ChannelBuilder
            .named(new ResourceLocation(TorchAction.MOD_ID, "network"))
    ...
    public static void register() {
        registerMessage(PacketPlaceTorch.class, PacketPlaceTorch::encode, PacketPlaceTorch::decode, PacketPlaceTorch.Handler::handle);
    }
